    ...
    <section className='mx-7'>
        <div className='grid grid-cols-2 mt-5 gap-5'>
            <div className='bg-[whitesmoke]'>
                <p className='py-10 font-bold text-5xl mx-7'>Get In Touch</p>
                <div className='flex flex-col pb-5 mx-7'>
        ...
        <div className='bg-[whitesmoke]'>
            <p className='text-5xl font-bold py-10 mx-7'>Let's Connect</p>
